  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="prueba3.jsp"> Contacto </a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-lg-4 col-sm-6 portfolio-item">
      ...
      <a href="offices?action=list&id=<c:out value="${office.id}"/>"><img class="card-img-top" src="image/${office.id}.jpg" height="250" >
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur eum quasi sapiente nesciunt? Voluptatibus
