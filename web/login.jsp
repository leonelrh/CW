        ...
        <div class="col-md-4 content-center">
            <div class="card card-login card-plain">
                <form class="form" method="post" action="login">
                    ...
                    <div class="pull-left">
                        <h6>
                            <a href="register.jsp" class="link"> Crear Cuenta </a>
                        </h6>
                    </div>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="copyright">
                ...
                <a href="http://www.invisionapp.com" target="_blank"> Workspace </a>. codigo por
                <a href="https://www.creative-tim.com" target="_blank">Coworking </a>.
            </div>
        </div>
    </footer>
</div>
